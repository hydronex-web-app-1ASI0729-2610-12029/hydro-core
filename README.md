...
<table align="center" border="1" width="70%" style="text-align:center;">
    ...
    <tr align="center">
        <td rowspan="3">
            <img src="./assets/team-member-profiles/foto_integrante5.png" alt="Integrante 5" style="margin-bottom: 5px;" width="800"/>
        </td>
        <td align="left">
            <b>Nombre y Apellido:</b>
            <br>
...
<div align=center>
    <img src="assets/leanuxcanvastankiq.png" alt="Lean UX Canvas"/>
</div>
...
<b>Escenario 1: Visualización del nivel</b><br>
Dado que existe una medición registrada del nivel de agua<br>
Cuando el administrador accede al sistema<br>
Entonces el sistema muestra el nivel actual de la cisterna<br><br>

<b>Escenario 2: Sin medición registrada</b><br>
Dado que no existe ninguna medición registrada<br>
Cuando el administrador accede<br>
...
<b>Escenario 1: Estado calculado</b><br>
Dado que existe una medición del nivel de agua<br>
Cuando accede al dashboard<br>
Entonces el sistema muestra el estado (normal, medio o crítico)<br><br>

<b>Escenario 2: Nivel crítico</b><br>
Dado que el nivel está por debajo del umbral mínimo configurado<br>
Cuando el sistema evalúa<br>
...
<b>Escenario 1: Cálculo de proyección</b><br>
Dado que existen registros históricos de consumo de agua<br>
Cuando consulta la proyección<br>
Entonces el sistema muestra los días estimados de disponibilidad<br><br>

<b>Escenario 2: Historial insuficiente</b><br>
Dado que no existen registros suficientes de consumo<br>
Cuando consulta la proyección<br>
...
<b>Escenario 1: Visualización completa</b><br>
Dado que existen registros de nivel de agua y consumo<br>
Cuando accede al dashboard<br>
Entonces el sistema muestra indicadores principales<br><br>

<b>Escenario 2: Información parcial</b><br>
Dado que falta información de consumo o nivel<br>
Cuando accede al dashboard<br>
...
<b>Escenario 1: Generación de alerta</b><br>
Dado que el nivel de agua está por debajo del umbral mínimo configurado<br>
Cuando el sistema evalúa el nivel<br>
Entonces genera una alerta crítica<br><br>

<b>Escenario 2: Notificación enviada</b><br>
Dado que se genera una alerta crítica<br>
Cuando ocurre el evento<br>
...
<b>Escenario 1: Lista de alertas</b><br>
Dado que existen alertas generadas<br>
Cuando accede a la sección<br>
Entonces el sistema muestra el listado de alertas<br><br>

<b>Escenario 2: Sin alertas</b><br>
Dado que no existen alertas registradas<br>
Cuando accede<br>
...
<b>Escenario 1: Notificación generada</b><br>
Dado que ocurre un evento relevante<br>
Cuando el sistema lo detecta<br>
Entonces envía una notificación al usuario<br><br>

<b>Escenario 2: Visualización de notificación</b><br>
Dado que el usuario tiene notificaciones<br>
Cuando accede al sistema<br>
...
<b>Escenario 1: Lista de notificaciones</b><br>
Dado que existen notificaciones<br>
Cuando accede a la sección<br>
Entonces el sistema muestra la lista<br><br>

<b>Escenario 2: Sin notificaciones</b><br>
Dado que no existen notificaciones<br>
Cuando accede<br>
...
Dado que ingresa datos válidos de recarga<br>
Cuando guarda la información<br>
Entonces el sistema actualiza el nivel de agua<br><br>
...
<b>Escenario 1: Visualización de historial</b><br>
Dado que existen registros de recargas<br>
Cuando accede a la sección<br>
Entonces el sistema muestra la lista de recargas<br><br>

<b>Escenario 2: Sin registros</b><br>
Dado que no existen recargas registradas<br>
Cuando accede<br>
...
Dado que existen registros de consumo de agua<br>
Cuando accede a la sección de historial<br>
Entonces el sistema muestra la lista de consumos registrados<br><br>

<b>Escenario 2: Sin registros de consumo</b><br>
Dado que no existen registros de consumo<br>
Cuando accede a la sección<br>
...
<b>Escenario 1: Visualización de análisis</b><br>
Dado que existen registros de consumo<br>
Cuando accede a la sección de análisis<br>
Entonces el sistema muestra gráficos o indicadores de consumo<br><br>

<b>Escenario 2: Sin datos para análisis</b><br>
...
<b>Escenario 1: Consumo mensual disponible</b><br>
Dado que existen registros de consumo en el mes<br>
Cuando selecciona el periodo mensual<br>
Entonces el sistema muestra el total de consumo<br><br>

<b>Escenario 2: Sin datos del mes</b><br>
Dado que no existen registros en el periodo seleccionado<br>
Cuando consulta<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Consumo diario disponible</b><br>
Dado que existen registros diarios de consumo<br>
Cuando consulta el detalle<br>
Entonces el sistema muestra el consumo por día<br><br>

<b>Escenario 2: Sin registros diarios</b><br>
Dado que no existen datos diarios registrados<br>
Cuando consulta<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Aplicación de filtros</b><br>
Dado que existen registros de consumo<br>
Cuando aplica un rango de fechas<br>
Entonces el sistema muestra los resultados filtrados<br><br>

<b>Escenario 2: Sin resultados</b><br>
Dado que no existen datos en el rango seleccionado<br>
Cuando aplica el filtro<br>
...
<b>Escenario 1: Visualización de tendencia</b><br>
Dado que existen registros históricos de consumo<br>
Cuando accede a la sección de tendencias<br>
Entonces el sistema muestra la evolución del consumo<br><br>

<b>Escenario 2: Sin historial suficiente</b><br>
...
<b>Escenario 1: Comparación de periodos</b><br>
Dado que existen datos en los periodos seleccionados<br>
Cuando realiza la comparación<br>
Entonces el sistema muestra la diferencia de consumo<br><br>

<b>Escenario 2: Periodo sin datos</b><br>
Dado que uno de los periodos no tiene registros<br>
Cuando intenta comparar<br>
Entonces el sistema muestra un mensaje informativo
...
Dado que existen datos de consumo y gastos<br>
Cuando solicita generar un reporte<br>
Entonces el sistema genera el documento<br><br>

<b>Escenario 2: Sin datos disponibles</b><br>
...
<b>Escenario 1: Descarga exitosa</b><br>
Dado que existe un reporte generado<br>
Cuando solicita la descarga<br>
Entonces el sistema descarga el archivo<br><br>

<b>Escenario 2: Sin reporte generado</b><br>
Dado que no existe un reporte previo<br>
Cuando intenta descargar<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Visualización de reportes</b><br>
Dado que existen reportes generados<br>
Cuando accede a la sección<br>
Entonces el sistema muestra la lista de reportes<br><br>

<b>Escenario 2: Sin reportes</b><br>
Dado que no existen reportes almacenados<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Compartir exitoso</b><br>
Dado que existe un reporte generado<br>
Cuando el administrador selecciona la opción de compartir<br>
Entonces el sistema envía el reporte a los destinatarios<br><br>

<b>Escenario 2: Sin reporte disponible</b><br>
Dado que no existe un reporte generado<br>
Cuando intenta compartir<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Aplicación de filtros</b><br>
Dado que existen reportes registrados<br>
Cuando aplica un filtro por fecha<br>
Entonces el sistema muestra los reportes correspondientes<br><br>

<b>Escenario 2: Sin resultados</b><br>
Dado que no existen reportes en el rango seleccionado<br>
Cuando aplica el filtro<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Registro exitoso</b><br>
Dado que ingresa el monto y la fecha de la recarga<br>
Cuando guarda la información<br>
Entonces el sistema registra el gasto correctamente<br><br>
...
<b>Escenario 1: Gasto mensual calculado</b><br>
Dado que existen registros de gastos en el mes<br>
Cuando consulta el periodo mensual<br>
Entonces el sistema muestra el total gastado<br><br>

<b>Escenario 2: Sin registros de gasto</b><br>
Dado que no existen gastos registrados en el mes<br>
Cuando consulta<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Visualización de gastos</b><br>
Dado que existen registros de gastos<br>
Cuando accede a la sección<br>
Entonces el sistema muestra los gastos registrados<br><br>

<b>Escenario 2: Sin gastos registrados</b><br>
Dado que no existen gastos registrados<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Estado visible</b><br>
Dado que existe una medición del nivel de agua<br>
Cuando accede al sistema<br>
Entonces el sistema muestra el estado actual de la cisterna<br><br>

<b>Escenario 2: Sin información disponible</b><br>
Dado que no existe medición registrada<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
Dado que existen registros de consumo<br>
Cuando accede a la sección<br>
Entonces el sistema muestra el historial<br><br>

<b>Escenario 2: Sin historial</b><br>
...
<b>Escenario 1: Visualización de alertas</b><br>
Dado que existen alertas generadas<br>
Cuando accede a la sección<br>
Entonces el sistema muestra las alertas<br><br>

<b>Escenario 2: Sin alertas</b><br>
Dado que no existen alertas<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
Dado que existen reportes generados<br>
Cuando accede a la sección<br>
Entonces el sistema muestra los reportes<br><br>

<b>Escenario 2: Sin reportes disponibles</b><br>
Dado que no existen reportes<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Configuración guardada</b><br>
Dado que ingresa un valor de umbral válido<br>
Cuando guarda la configuración<br>
Entonces el sistema actualiza el umbral<br><br>

<b>Escenario 2: Valor inválido</b><br>
Dado que el valor ingresado es incorrecto o vacío<br>
...
<b>Escenario 1: Registro exitoso</b><br>
Dado que el administrador ingresa datos válidos del edificio<br>
Cuando guarda la información<br>
Entonces el sistema registra los datos correctamente<br><br>
...
Entonces el sistema le permite acceder<br><br>

<b>Escenario 2: Credenciales incorrectas</b><br>
Dado que el usuario ingresa datos inválidos<br>
...
<b>Escenario 1: Registro exitoso</b><br>
Dado que ingresa datos válidos<br>
Cuando completa el formulario<br>
Entonces el sistema crea la cuenta<br><br>

<b>Escenario 2: Datos inválidos</b><br>
Dado que los datos ingresados son incorrectos o incompletos<br>
...
<b>Escenario 1: Cierre exitoso</b><br>
Dado que el usuario tiene una sesión activa<br>
Cuando selecciona cerrar sesión<br>
Entonces el sistema finaliza la sesión<br><br>

<b>Escenario 2: Sesión no activa</b><br>
Dado que no existe sesión activa<br>
Cuando intenta cerrar sesión<br>
Entonces el sistema muestra un mensaje informativo
...
Dado que el usuario ingresa un correo registrado<br>
Cuando solicita recuperación<br>
Entonces el sistema envía instrucciones<br><br>

<b>Escenario 2: Correo no registrado</b><br>
Dado que el correo no existe en el sistema<br>
Cuando solicita recuperación<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Información comprensible</b><br>
Dado que el sistema muestra datos<br>
Cuando el usuario accede<br>
Entonces la información es clara y entendible<br><br>

<b>Escenario 2: Información no disponible</b><br>
Dado que no existen datos<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Acceso desde móvil</b><br>
Dado que el usuario accede desde un dispositivo móvil<br>
Cuando ingresa al sistema<br>
Entonces puede visualizar y usar las funcionalidades<br><br>

<b>Escenario 2: Error de acceso</b><br>
Dado que ocurre un problema al cargar la página<br>
Cuando intenta acceder<br>
Entonces el sistema muestra un mensaje de error
...
<b>Escenario 1: Consumo alto detectado</b><br>
Dado que el consumo supera el valor esperado<br>
Cuando el sistema evalúa<br>
Entonces genera una alerta<br><br>

<b>Escenario 2: Notificación enviada</b><br>
Dado que se genera la alerta<br>
Cuando ocurre el evento<br>
...
<b>Escenario 1: Consumo anómalo detectado</b><br>
Dado que el consumo difiere del comportamiento habitual<br>
Cuando el sistema analiza los datos<br>
Entonces genera una alerta<br><br>

<b>Escenario 2: Sin anomalías</b><br>
Dado que el consumo es normal<br>
Cuando el sistema evalúa<br>
...
<b>Escenario 1: Notificación de corte</b><br>
Dado que existe un corte programado<br>
Cuando el sistema lo registra<br>
Entonces envía una notificación al usuario<br><br>

<b>Escenario 2: Sin cortes programados</b><br>
Dado que no existen cortes<br>
Cuando el usuario consulta<br>
...
<b>Escenario 1: Disponibilidad visible</b><br>
Dado que existe una medición del nivel de agua<br>
Cuando el usuario accede al sistema<br>
Entonces el sistema muestra si hay disponibilidad de agua<br><br>
...
<b>Escenario 1: Resumen disponible</b><br>
Dado que existen datos de nivel y consumo<br>
Cuando accede al dashboard<br>
Entonces el sistema muestra un resumen general<br><br>

<b>Escenario 2: Información incompleta</b><br>
Dado que faltan datos<br>
Cuando accede<br>
...
<b>Escenario 1: Información reciente</b><br>
Dado que existen mediciones actualizadas del sistema<br>
Cuando el usuario accede<br>
Entonces el sistema muestra los datos más recientes<br><br>

<b>Escenario 2: Información desactualizada</b><br>
Dado que no hay actualización reciente<br>
Cuando accede<br>
...
<b>Escenario 1: Navegación mediante menú</b><br>
Dado que el visitante accede al sitio<br>
Cuando hace clic en una opción del menú<br>
Entonces la página se desplaza a la sección correspondiente<br><br>

<b>Escenario 2: Navegación por scroll</b><br>
Dado que el visitante se encuentra en el landing<br>
...
<b>Escenario 1: Visualización del mensaje principal</b><br>
Dado que el visitante accede al inicio<br>
Cuando visualiza el contenido principal<br>
Entonces comprende el propósito del sistema<br><br>

<b>Escenario 2: Contenido no visible</b><br>
Dado que ocurre un error de carga<br>
Cuando accede al sitio<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Visualización de problemas</b><br>
Dado que el visitante accede a la sección correspondiente<br>
Cuando revisa el contenido<br>
Entonces visualiza problemas reales del suministro de agua<br><br>

<b>Escenario 2: Sección no disponible</b><br>
Dado que la sección no carga correctamente<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Visualización del proceso</b><br>
Dado que el visitante accede a la sección “cómo funciona”<br>
Cuando revisa el contenido<br>
Entonces visualiza los pasos del funcionamiento<br><br>

<b>Escenario 2: Contenido no disponible</b><br>
Dado que la sección no carga correctamente<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Beneficios visibles</b><br>
Dado que el visitante accede a la sección de beneficios<br>
Cuando revisa el contenido<br>
Entonces visualiza ventajas del sistema<br><br>

<b>Escenario 2: Sin contenido</b><br>
Dado que la sección no carga<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
Cuando revisa el contenido<br>
Entonces visualiza las opciones disponibles<br><br>

<b>Escenario 2: Sin planes disponibles</b><br>
Dado que no existen planes configurados<br>
Cuando accede<br>
Entonces el sistema muestra un mensaje informativo
...
Dado que el visitante completa el formulario correctamente<br>
Cuando envía la información<br>
Entonces el sistema registra la solicitud<br><br>
...
<b>Escenario 1: Redirección al formulario</b><br>
Dado que el visitante se encuentra en el landing<br>
Cuando hace clic en un botón de acción<br>
Entonces la página se desplaza a la sección de contacto<br><br>

<b>Escenario 2: Botón no funcional</b><br>
Dado que ocurre un error en la navegación<br>
Cuando hace clic en el botón<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Navegación correcta</b><br>
Dado que el visitante selecciona un enlace del menú<br>
Cuando hace clic<br>
Entonces el sistema lo dirige a la sección correspondiente<br><br>

<b>Escenario 2: Enlace no disponible</b><br>
Dado que el enlace no funciona correctamente<br>
Cuando el visitante hace clic<br>
Entonces el sistema muestra un mensaje informativo
...
<b>Escenario 1: Contenido organizado</b><br>
Dado que el visitante accede al landing<br>
Cuando revisa la página<br>
Entonces visualiza secciones organizadas (problema, solución, beneficios, contacto)<br><br>

<b>Escenario 2: Contenido no cargado</b><br>
Dado que ocurre un error en la carga<br>
Cuando accede al sitio<br>
Entonces el sistema muestra un mensaje informativo
...
<div align="center">
    <img src="assets/colors/29ABE2color.png" alt="Celeste Principal #29ABE2" width="600"/>
</div>
...
<div align="center">
    <img src="assets/colors/2D2D2Dcolor.png" alt="Gris Oscuro #2D2D2D" width="600"/>
</div>
...
<div align="center">
    <img src="assets/colors/F4F4F4color.png" alt="Gris Claro #F4F4F4" width="600"/>
</div>
...
<div align="center">
    <img src="assets/colors/E53935color.png" alt="Rojo Alerta #E53935" width="600"/>
</div>
...
<div align="center"><img src="assets/wireframes/landingpageproblema.png" alt="Wireframe Landing Page Problema" width="700"/></div>
...
<div align="center"><img src="assets/wireframes/landingpageplanes.png" alt="Wireframe Landing Page Planes" width="700"/></div>
...
<div align="center"><img src="assets/mockups/landingmkproblema.png" alt="Mock-up Landing Page Problema" width="700"/></div>
...
<div align="center"><img src="assets/mockups/landingmkfunciona.png" alt="Mock-up Landing Page Cómo funciona" width="700"/></div>
...
<div align="center"><img src="assets/mockups/landingmkbeneficios.png" alt="Mock-up Landing Page Beneficios" width="700"/></div>
...
<div align="center"><img src="assets/mockups/landingmkahorro.png" alt="Mock-up Landing Page Ahorro" width="700"/></div>
...
<div align="center"><img src="assets/mockups/landingmkplanes.png" alt="Mock-up Landing Page Planes" width="700"/></div>
...
<div align="center"><img src="assets/wireframes/wflogin.png" alt="Wireframe Login TankIQ" width="700"/></div>

**Pantalla 02: Registro de administrador**
<div align="center"><img src="assets/wireframes/wfregistro.png" alt="Wireframe Registro TankIQ" width="700"/></div>

**Pantalla 03: Dashboard administrador**
<div align="center"><img src="assets/wireframes/wfdashboard.png" alt="Wireframe Dashboard TankIQ" width="700"/></div>

**Pantalla 04: Alertas**
<div align="center"><img src="assets/wireframes/wfalertas.png" alt="Wireframe Alertas TankIQ" width="700"/></div>

**Pantalla 05: Perfil del administrador**
<div align="center"><img src="assets/wireframes/wfperfil.png" alt="Wireframe Perfil TankIQ" width="700"/></div>

**Pantalla 06: Reportes para junta de propietarios**
<div align="center"><img src="assets/wireframes/wfreportes.png" alt="Wireframe Reportes TankIQ" width="700"/></div>

**Pantalla 07: Historial de recargas y consumo**
<div align="center"><img src="assets/wireframes/wfhistorial.png" alt="Wireframe Historial TankIQ" width="700"/></div>

**Pantalla 08: Configuración de edificio y alertas**
<div align="center"><img src="assets/wireframes/wfconfiguracion.png" alt="Wireframe Configuración TankIQ" width="700"/></div>

**Pantalla 09: Vista de solo lectura (propietario / inquilino)**
<div align="center"><img src="assets/wireframes/wfpropietario.png" alt="Wireframe Vista Propietario TankIQ" width="700"/></div>
...
<div align="center"><img src="assets/wireflows/wfgastosagua.png" alt="Wireflow UG10 Notificaciones propietario TankIQ" width="700"/></div>
...
**Pantalla 01: Inicio de sesión**
<div align="center"><img src="assets/mockups/mklogin.png" alt="Mock-up Login TankIQ" width="700"/></div>

**Pantalla 02: Registro de administrador**
<div align="center"><img src="assets/mockups/mkregistro.png" alt="Mock-up Registro TankIQ" width="700"/></div>

**Pantalla 03: Dashboard administrador**
<div align="center"><img src="assets/mockups/mkdashboard.png" alt="Mock-up Dashboard TankIQ" width="700"/></div>

**Pantalla 04: Alertas**
<div align="center"><img src="assets/mockups/mkalertas.png" alt="Mock-up Alertas TankIQ" width="700"/></div>

**Pantalla 05: Perfil del administrador**
<div align="center"><img src="assets/mockups/mkperfil.png" alt="Mock-up Perfil TankIQ" width="700"/></div>

**Pantalla 06: Reportes para junta de propietarios**
<div align="center"><img src="assets/mockups/mkreportes.png" alt="Mock-up Reportes TankIQ" width="700"/></div>

**Pantalla 07: Historial de recargas y consumo**
<div align="center"><img src="assets/mockups/mkhistorial.png" alt="Mock-up Historial TankIQ" width="700"/></div>

**Pantalla 08: Configuración de edificio y alertas**
<div align="center"><img src="assets/mockups/mkconfiguracion.png" alt="Mock-up Configuración TankIQ" width="700"/></div>

**Pantalla 09: Vista de solo lectura (propietario / inquilino)**
<div align="center"><img src="assets/mockups/mkpropietario.png" alt="Mock-up Vista Propietario TankIQ" width="700"/></div>
...
<div align="center"><img src="assets/wireflows/wfmkgastosagua.png" alt="Wireflow UG10 Notificaciones propietario TankIQ" width="700"/></div>
