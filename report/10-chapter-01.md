...
<table align="center" border="1" width="70%" style="text-align:center;">
    <tr align="center">
        <td rowspan="3">
            <img src="assets/team-member-profiles/Diego.png" alt="Integrante 1" style="margin-bottom: 5px; width: 200px"/>
        </td>
        <td align="left">
    ...
    <tr align="center">
        <td rowspan="3">
            <img src="assets/team-member-profiles/Bruno.png" alt="Integrante 2" style="margin-bottom: 5px; width: 200px"/>
        </td>
        <td align="left">
            <b>Nombre y Apellido:</b>
            <br>
    ...
    <tr align="center">
        <td rowspan="3">
            <img src="assets/team-member-profiles/Integrante_Gabriel.png" alt="Integrante 3" style="margin-bottom: 5px; width: 200px"/>
        </td>
        <td align="left">
            <b>Nombre y Apellido:</b>
            <br>
    ...
    <tr align="center">
        <td rowspan="3">
            <img src="assets/team-member-profiles/juan.jpeg" alt="Integrante 4" style="margin-bottom: 5px; width: 200px"/>
        </td>
        <td align="left">
            <b>Nombre y Apellido:</b>
            <br>
...
<img src="assets/leanuxcanvastankiq.png" alt="Lean UX Canvas" style="width: 700px; height: 450px;"/>
